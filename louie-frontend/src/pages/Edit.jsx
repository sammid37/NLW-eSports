...
export default function Edit() {
  ...
  // colect data from backend
  const loadSupplies = async () => {
    const result = await axios.get(`http://localhost:8080/louie/${id}`)
    setSupplies(result.data)
  }

  // submit changes and navigate back to /louie
  const handleSubmit = async(event) => {
    event.preventDefault();
    await axios.put(`http://localhost:8080/louie/${id}`, supplies);
          ...
          <form className="louie-forms" onSubmit={handleSubmit}>
            <div className="louie-left">
              ...
              <div className="louie-row">
                ...
                <div className="louie-item">
                <label className="louie-label">grade</label><br />
